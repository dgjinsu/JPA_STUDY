...
class MemberRepositoryTest {
    ...
    public void basicCRUD() {
        ...
        long after_delete_count = memberRepository.count();
        assertThat(after_delete_count).isEqualTo(0);
    }
    ...
    public void paging() {
        ...
        //when
        Page<Member> page = memberRepository.findByAge(age, pageRequest); // totalcount 쿼리까지 같이 날림

        //map 을 사용해서 Dto 로 쉽게 변환할 수 있다.
    ...
    public void bulkUpdate() {
        ...
        memberRepository.save(new Member("member6", 33));
